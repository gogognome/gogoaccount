...
public class LedgerService {
    ...
    private final PaymentAmountAgainstDebtorAndCreditorValidator paymentAmountAgainstDebtorAndCreditorValidator;

    public LedgerService(TextResource textResource, ConfigurationService configurationService, InvoiceService invoiceService,
                         PartyService partyService, PaymentAmountAgainstDebtorAndCreditorValidator paymentAmountAgainstDebtorAndCreditorValidator) {
        this.textResource = textResource;
        this.configurationService = configurationService;
        this.invoiceService = invoiceService;
        this.partyService = partyService;
        this.paymentAmountAgainstDebtorAndCreditorValidator = paymentAmountAgainstDebtorAndCreditorValidator;
    }
    ...
    public JournalEntry addJournalEntry(Document document, JournalEntry journalEntry, List<JournalEntryDetail> journalEntryDetails, boolean createPayments)
        ...
        return ServiceTransaction.withResult(() -> {
            ...
            if (createPayments) {
                paymentAmountAgainstDebtorAndCreditorValidator.validate(document, journalEntryDetails);
